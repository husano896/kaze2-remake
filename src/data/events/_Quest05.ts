 ...
 *                     bossDat = "Quest04
                    bossNm = "-rag
                    BossCG = "best11
                    DragonChip_ChkBit = 2048;
                    varURL = "games05a.html?Lv4
                    document.write("<DIV ID = 'BG' STYLE='position:absolute;top:8px;left:0px; visibility:hidden;'>");
                    document.write("<IMG width=100% src='image/bg_ragunaroku.jpg' border=0></DIV>");
 */
/** TODO: ドラゴンの丘 */
export const Quest05 = async (component: DialogueComponent) => {
  const { saveData, SetContentCompleted, ClearContent, Content, Back, setDialogOpticity, appServ, router, setBG, setDragonCG, setBGOpticity, setDragonCGOpticity } = component;
